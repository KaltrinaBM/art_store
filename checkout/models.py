...
class Order(models.Model):
    ...
    def update_total(self):
        ...
        without accounting for delivery costs as shipping is free."""
        self.order_total = (
            self.items.aggregate(Sum('item_total'))['item_total__sum'] or 0
            )
...
class OrderItem(models.Model):
    ...
    painting = models.ForeignKey(Painting, null=False, blank=False,
